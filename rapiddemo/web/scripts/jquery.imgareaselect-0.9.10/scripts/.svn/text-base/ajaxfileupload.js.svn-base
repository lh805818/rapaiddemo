		...
		{			
			...
			{				
                ...
                try {
                    ...
                    // Make sure that the request was successful or notmodifieduploadHttpData
                    if ( status != "error" )
					{
                        ...
                        if ( s.success ){
                        	var tempjson = data.substring(data.indexOf('{\"'),parseInt(data.indexOf('\"}')))+"\"}";
                        	var dataval = eval( "data = " + tempjson )
                            s.success(dataval, status );
                        }
